...
namespace RoomManager
{
    public partial class frmIns_CustomerGroups : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmIns_CustomerGroups(frmTsk_CheckIn_Group_Step2 afrmTsk_CheckIn_Group_Step2, int IDCompany, string NameCompany)
        {
            InitializeComponent();
        ...
        public frmIns_CustomerGroups(frmTsk_CheckInGoverment_ForRoomBooking_Step2 afrmTsk_CheckInGoverment_ForRoomBooking_Step2, int IDCompany, string NameCompany)
        {
            InitializeComponent();
        ...
        public frmIns_CustomerGroups(frmTsk_CheckInGroup_ForRoomBooking_Step2 afrmTsk_CheckInGroup_ForRoomBooking_Step2, int IDCompany, string NameCompany)
        {
            InitializeComponent();
        ...
        public frmIns_CustomerGroups(frmTsk_CheckInCustomer_ForRoomBooking_Step2 afrmTsk_CheckInCustomer_ForRoomBooking_Step2, int IDCompany, string NameCompany)
        {
            InitializeComponent();
        ...
        private void btnAddNew_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.ValidateData() == true)
                {
                    ...
                    if (this.afrmTsk_CheckIn_Group_Step2 != null)
                    {
                        this.afrmTsk_CheckIn_Group_Step2.LoadIDCustomerGroups();
                    }
                    else if (this.afrmTsk_CheckIn_Goverment_Step2 != null)
                    {
                        this.afrmTsk_CheckIn_Goverment_Step2.LoadIDCustomerGroups();
                    }
                    else if (this.afrm_Tsk_CheckIn_Customer_Step2 != null)
                    {
                        this.afrm_Tsk_CheckIn_Customer_Step2.LoadCustomerGroup();
                    }
                    else if (this.afrmLst_CustomerGroups_Old != null)
                    {
                        afrmLst_CustomerGroups_Old.ReloadData();
                    }
                    else if (this.afrmTsk_Booking_Step2 != null)
                    {
                        this.afrmTsk_Booking_Step2.LoadIDCustomerGroups();
                    }
                    else if (this.afrmLst_CustomerGroups_Old != null)
                    {
                        this.afrmLst_CustomerGroups_Old.ReloadData();
                    }
                    else if (afrmIns_CustomerGroups_Customers_Old != null)
                    {
                        afrmIns_CustomerGroups_Customers_Old.LoadIDCustomerGroups();
                    }
                    else if (this.afrmTsk_CheckInGoverment_ForRoomBooking_Step2 != null)
                    {
                        this.afrmTsk_CheckInGoverment_ForRoomBooking_Step2.LoadIDCustomerGroups();
                    }
                    else if (this.afrmTsk_CheckInGroup_ForRoomBooking_Step2 != null)
                    {
                        this.afrmTsk_CheckInGroup_ForRoomBooking_Step2.LoadIDCustomerGroups();
                    }
                    else if (this.afrmTsk_CheckInCustomer_ForRoomBooking_Step2 != null)
                    {
                        this.afrmTsk_CheckInCustomer_ForRoomBooking_Step2.LoadCustomerGroup();
                    }
