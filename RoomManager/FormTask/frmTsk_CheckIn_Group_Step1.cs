...
{
    public partial class frmTsk_CheckIn_Group_Step1 : DevExpress.XtraEditors.XtraForm
    {
        ...
        //hiennv
        public frmTsk_CheckIn_Group_Step1(frmMain afrmMain, string codeRoom)
        {
            InitializeComponent();
            this.afrmMain = afrmMain;
            this.codeRoom = codeRoom;
        }
        public frmTsk_CheckIn_Group_Step1(frmMain afrmMain)
        {
            InitializeComponent();
            this.afrmMain = afrmMain;
        }
        ...
        private void btnRemoveSelectedRooms_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step1.btnRemoveSelectedRooms_ButtonClick\n" + ex.ToString(), "Error ", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            try
            {
                if (aCheckInEN.aListRoomMembers.Count > 0)
                {
                    ...
                    frmTsk_CheckIn_Group_Step2 afrmTsk_CheckIn_Group_Step2 = new frmTsk_CheckIn_Group_Step2(this, aCheckInEN);
                    afrmTsk_CheckIn_Group_Step2.ShowDialog();
                }
                else
                {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step1.btnNext_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private bool CheckData()
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step1.CheckData\n" + ex.ToString(), "Error ", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        ...
        public void LoadListAvailableRooms(DateTime fromDate, DateTime toDate)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step1.LoadListAvailableRooms\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}