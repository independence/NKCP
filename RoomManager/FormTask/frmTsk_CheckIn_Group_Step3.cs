...
{
    public partial class frmTsk_CheckIn_Group_Step3 : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmTsk_CheckIn_Group_Step3(frmTsk_CheckIn_Group_Step2 afrmTsk_CheckIn_Group_Step2, CheckInEN aCheckInData)
        {
            InitializeComponent();
            this.afrmTsk_CheckIn_Group_Step2 = afrmTsk_CheckIn_Group_Step2;
            this.aCheckInEN = aCheckInData;
        ...
        private void frmTsk_CheckIn_Group_Step3_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step3.frmTsk_CheckIn_Group_Step3_Load\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void LoadLueIDRooms()
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step3.LoadLueIDRooms\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void lueIDRooms_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step3.lueIDRooms_EditValueChanged\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnSelectCustomer_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                aCustomersInfo.ID = Convert.ToInt32(viewAvailableCustomer.GetFocusedRowCellValue("ID").ToString());
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step3.btnSelectCustomer_ButtonClick\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnRemoveCustomer_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                aCustomers.ID = Convert.ToInt32(viewSelectCustomer.GetFocusedRowCellValue("ID").ToString());
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step3.btnRemoveCustomer_ButtonClick\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        private void btReservation_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                aCheckInEN.CustomerType = 2;  // 1: Khach nha nuoc, 2: Khach doan, 3: khach le, 4: Khach vang lai
                ...
                this.afrmTsk_CheckIn_Group_Step2.Close();
                this.afrmTsk_CheckIn_Group_Step2.afrmTsk_CheckIn_Group_Step1.Close();
                if (this.afrmTsk_CheckIn_Group_Step2.afrmTsk_CheckIn_Group_Step1.afrmMain !=null)
                {
                    this.afrmTsk_CheckIn_Group_Step2.afrmTsk_CheckIn_Group_Step1.afrmMain.ReloadData();
                }
                this.Close();
            }
            catch (Exception ex)
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step3.btReservation_Click\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void viewSelectCustomer_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step3.viewSelectCustomer_RowClick\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public void ReloadExtendInfoBookingRoomMembers(int IDCustomer)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step3.ReloadExtendInfoBookingRoomMembers\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void dtpDateEnterCountry_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step3.dtpDateEnterCountry_Leave\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
