...
{
    public partial class frmTsk_CheckInGoverment_ForRoomBooking_Step2 : DevExpress.XtraEditors.XtraForm
    {

        public frmTsk_CheckInGoverment_ForRoomBooking_Step1 afrmTsk_CheckInGoverment_ForRoomBooking_Step1 = null;
        ...
        public frmTsk_CheckInGoverment_ForRoomBooking_Step2(frmTsk_CheckInGoverment_ForRoomBooking_Step1 afrmTsk_CheckInGoverment_ForRoomBooking_Step1, CheckInRoomBookingEN aCheckInRoomBookingEN)
        {
            InitializeComponent();
            this.afrmTsk_CheckInGoverment_ForRoomBooking_Step1 = afrmTsk_CheckInGoverment_ForRoomBooking_Step1;
        ...
        public void CallBackIDCustomerGroup(int IDCustomerGroup)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.CallBackIDCustomerGroup\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public void CallBackIDCustomer(int IDCustomer)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.CallBackIDCustomer\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        public void LoadIDCompanies()
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.LoadIDCompanies\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        //CallBackIDCompany
        public void CallBackIDCompany(int IDCompany)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.CallBackIDCompany\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public void LoadIDCustomerGroups()
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.LoadIDCustomerGroups\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        //Load IDCustomers 
        public void LoadIDCustomers()
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.LoadIDCustomers\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void lueIDCompanies_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.lueIDCompanies_EditValueChanged\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void lueIDCustomerGroups_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.lueIDCustomerGroups_EditValueChanged\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnSearchCompanies_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.bt_BookingRs_Search_Company_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnAddCustomerGroups_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.btnAddCustomerGroups_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnAddCompanies_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.btnCompanies_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnSearchCustomerGroups_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.btnSearchCustomerGroups_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnAddCustomers_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.btnAddCustomers_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnSearchCustomers_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.btnSearchCustomers_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private bool ValidateData()
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.ValidateData\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        ...
        private void btNext_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.ValidateData() == true)
                {
                    ...
                    this.aCheckInRoomBookingEN.Level = Convert.ToInt32(lueLevel.EditValue);
                    ...
                    frmTsk_CheckInGoverment_ForRoomBooking_Step3 afrmTsk_CheckInGoverment_ForRoomBooking_Step3 = new frmTsk_CheckInGoverment_ForRoomBooking_Step3(this, this.aCheckInRoomBookingEN);
                    afrmTsk_CheckInGoverment_ForRoomBooking_Step3.ShowDialog();
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.btNext_Click\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void frmTsk_CheckIn_Goverment_Step2_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                lueLevel.EditValue = CORE.CONSTANTS.SelectedLevel(this.aCheckInRoomBookingEN.Level).ID;
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step2.frmTsk_CheckIn_Goverment_Step2_Load\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
