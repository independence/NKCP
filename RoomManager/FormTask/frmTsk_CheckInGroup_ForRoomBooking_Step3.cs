...
{
    public partial class frmTsk_CheckInGroup_ForRoomBooking_Step3 : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmTsk_CheckIn_Group_Step3_Load(object sender, EventArgs e)
        {
            try
            {

                lueIDRooms.Properties.DataSource = this.aCheckInRoomBookingEN.aListRoomMembers;
                lueIDRooms.Properties.DisplayMember = "RoomSku";
                lueIDRooms.Properties.ValueMember = "RoomCode";
                lueIDRooms.EditValue = this.aCheckInRoomBookingEN.aListRoomMembers.ToList()[0].RoomCode;
            ...
            {
                MessageBox.Show("frmTsk_CheckInGroup_ForRoomBooking_Step3.frmTsk_CheckIn_Group_Step3_Load\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void LoadLueIDRooms()
        {
            try
            {
                ...
                dgvSelectCustomer.DataSource = this.aCheckInRoomBookingEN.aListRoomMembers[Index].ListCustomer;
            ...
            {
                MessageBox.Show("frmTsk_CheckInGroup_ForRoomBooking_Step3.LoadLueIDRooms\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void lueIDRooms_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGroup_ForRoomBooking_Step3.lueIDRooms_EditValueChanged\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnSelectCustomer_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                RoomMemberEN aItem = this.aCheckInRoomBookingEN.aListRoomMembers.Where(p => p.RoomCode == lueIDRooms.EditValue.ToString()).ToList()[0];
                int Index = this.aCheckInRoomBookingEN.aListRoomMembers.IndexOf(aItem);
            ...
            {
                MessageBox.Show("frmTsk_CheckInGroup_ForRoomBooking_Step3.btnSelectCustomer_ButtonClick\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnRemoveCustomer_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                CustomerInfoEN Temps = this.aCheckInRoomBookingEN.aListRoomMembers[Index].ListCustomer.Where(c => c.ID == Convert.ToInt32(viewSelectCustomer.GetFocusedRowCellValue("ID"))).ToList()[0];
            ...
            {
                MessageBox.Show("frmTsk_CheckInGroup_ForRoomBooking_Step3.btnRemoveCustomer_ButtonClick\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        private void btReservation_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (success == true)
                {
                    ...
                    if (this.afrmTsk_CheckInGroup_ForRoomBooking_Step2.afrmTsk_CheckInGroup_ForRoomBooking_Step1.afrmTsk_ListBookingRs != null)
                    {
                        this.afrmTsk_CheckInGroup_ForRoomBooking_Step2.afrmTsk_CheckInGroup_ForRoomBooking_Step1.afrmTsk_ListBookingRs.Reload();
                        if (this.afrmTsk_CheckInGroup_ForRoomBooking_Step2.afrmTsk_CheckInGroup_ForRoomBooking_Step1.afrmTsk_ListBookingRs.afrmMain != null)
                        {
                            this.afrmTsk_CheckInGroup_ForRoomBooking_Step2.afrmTsk_CheckInGroup_ForRoomBooking_Step1.afrmTsk_ListBookingRs.afrmMain.ReloadData();
                        }
                    }
                    if (this.afrmTsk_CheckInGroup_ForRoomBooking_Step2.afrmTsk_CheckInGroup_ForRoomBooking_Step1.afrmMain != null)
                    {
                        this.afrmTsk_CheckInGroup_ForRoomBooking_Step2.afrmTsk_CheckInGroup_ForRoomBooking_Step1.afrmMain.ReloadData();
                    }

                    this.Close();
                    this.afrmTsk_CheckInGroup_ForRoomBooking_Step2.Close();
                    this.afrmTsk_CheckInGroup_ForRoomBooking_Step2.afrmTsk_CheckInGroup_ForRoomBooking_Step1.Close();
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show("frmTsk_CheckInGroup_ForRoomBooking_Step3.btReservation_Click\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void viewSelectCustomer_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGroup_ForRoomBooking_Step3.viewSelectCustomer_RowClick\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public void ReloadExtendInfoBookingRoomMembers(int IDCustomer)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGroup_ForRoomBooking_Step3.ReloadExtendInfoBookingRoomMembers\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void AddExtendInfoBookingRoomMembers()
        {
            try
            {
                ...
                RoomMemberEN aRoomMemberEN = this.aCheckInRoomBookingEN.aListRoomMembers.Where(a => a.RoomCode == lueIDRooms.EditValue.ToString()).ToList()[0];
                int index = this.aCheckInRoomBookingEN.aListRoomMembers.IndexOf(aRoomMemberEN);
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step3.AddExtendInfoBookingRoomMembers\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void dtpDateEnterCountry_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGroup_ForRoomBooking_Step3.dtpDateEnterCountry_Leave\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
