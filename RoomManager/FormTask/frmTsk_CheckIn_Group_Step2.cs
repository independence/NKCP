...
{
    public partial class frmTsk_CheckIn_Group_Step2 : DevExpress.XtraEditors.XtraForm
    {
        public frmTsk_CheckIn_Group_Step1 afrmTsk_CheckIn_Group_Step1 = null;
        private CheckInEN aCheckInEN = new CheckInEN();

        public frmTsk_CheckIn_Group_Step2(frmTsk_CheckIn_Group_Step1 afrmTsk_CheckIn_Group_Step1, CheckInEN aCheckInEN)
        {
            InitializeComponent();
            this.afrmTsk_CheckIn_Group_Step1 = afrmTsk_CheckIn_Group_Step1;
        ...
        public void CallBackIDCustomerGroup(int IDCustomerGroup)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.CallBackIDCustomerGroup\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public void CallBackIDCustomer(int IDCustomer)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.CallBackIDCustomer\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public void CallBackIDCompany(int IDCompany)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.CallBackIDCompany\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public void LoadIDCustomerGroups()
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.LoadIDCustomerGroups\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public void LoadIDCustomers()
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.LoadIDCustomers\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnAddCompanies_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.btnAddCompanies_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnSearchCompanies_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.btnSearchCompanies_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnAddCustomerGroups_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.btnAddCustomerGroups_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnSearchCustomerGroups_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.btnSearchCustomerGroups_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnAddCustomers_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.btnAddCustomers_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnSearchCustomers_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.btnSearchCustomers_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.ValidateData() == true)
                {
                    ...
                    frmTsk_CheckIn_Group_Step3 afrmTsk_CheckIn_Group_Step3 = new frmTsk_CheckIn_Group_Step3(this, aCheckInEN);
                    afrmTsk_CheckIn_Group_Step3.ShowDialog();
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.btnNext_Click\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void lueIDCompanies_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.lueIDCompanies_EditValueChanged\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void lueIDCustomerGroups_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.lueIDCustomerGroups_EditValueChanged\n" + ex.ToString(), "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void frmTsk_CheckIn_Group_Step2_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckIn_Group_Step2.frmTsk_CheckIn_Group_Step2_Load\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
