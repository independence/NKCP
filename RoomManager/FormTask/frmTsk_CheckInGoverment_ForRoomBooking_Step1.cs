...
{
    public partial class frmTsk_CheckInGoverment_ForRoomBooking_Step1 : DevExpress.XtraEditors.XtraForm
    {
        ...
        //hiennv
        public frmTsk_CheckInGoverment_ForRoomBooking_Step1(frmTsk_ListBookingRs afrmTsk_ListBookingRs,int IDBookingRs,DateTime CheckOutPlan)
        {
            InitializeComponent();
        ...
        private void btnAddSelectedRooms_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            try
            {
                ...
                this.aCheckInRoomBookingEN.aListRoomMembers.Insert(aCheckInRoomBookingEN.aListRoomMembers.Count, aRoomMemberEN);
                dgvSelectedRooms.DataSource = this.aCheckInRoomBookingEN.aListRoomMembers;
                dgvSelectedRooms.RefreshDataSource();

                RoomsEN Temps = this.aListAvaiableRooms.Where(p => p.Sku == viewAvailableRooms.GetFocusedRowCellValue("Sku").ToString()).ToList()[0];
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step1.btnAddSelectedRooms_ButtonClick\n" + ex.ToString(), "Error ", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        //hiennv
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step1.btnSearch_Click\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        //hiennv
        ...
        private void frmTsk_CheckIn_Goverment_Step1_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step1.frmTsk_CheckIn_Goverment_Step1_Load\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private bool CheckData()
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step1.CheckData\n" + ex.ToString(), "Error ", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        ...
        public void LoadListAvailableRooms(DateTime fromDate, DateTime toDate)
        {
            ...
            {
                MessageBox.Show("frmTsk_CheckInGoverment_ForRoomBooking_Step1.LoadListAvailableRooms\n" + ex.ToString(), "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
