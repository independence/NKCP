...
namespace DataAccess
{
    ...
    public partial class sp_PaymentExt_GetAllData_1_Result
    {
        ...
        public Nullable<double> QualityServices { get; set; }
        public Nullable<decimal> Services_Cost { get; set; }
        public Nullable<double> Services_PercentTax { get; set; }
        ...
        public Nullable<int> Bill_SubPayment { get; set; }
